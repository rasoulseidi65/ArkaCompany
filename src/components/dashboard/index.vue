<template>
    <div dir="rtl" class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden" >
    <header class="app-header navbar" style="background-color: #00003b;color: white">
        <button class="navbar-toggler mobile-sidebar-toggler d-lg-none mr-auto" type="button">☰</button>
        <a class="navbar-brand" href="#"></a>
        <button class="navbar-toggler sidebar-minimizer d-md-down-none" type="button" style="color:white;">☰</button>

        <ul class="nav navbar-nav d-md-down-none" >
            <li class="nav-item px-3">
                <a class="nav-link" href="#" style="color:white;">میزکار</a>
            </li>
            <li class="nav-item px-3">
                <a class="nav-link" href="#" style="color:white;">کاربران</a>
            </li>
            <li class="nav-item px-3">
                <a class="nav-link" href="#" style="color:white;">تنظیمات</a>
            </li>
        </ul>
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item d-md-down-none">
                <a class="nav-link" href="#" style="color:white;"><i class="icon-bell" style="color:white;"></i><span class="badge badge-pill badge-danger">5</span></a>
            </li>
            <li class="nav-item d-md-down-none">
                <a class="nav-link" href="#" style="color:white;"><i class="icon-list"></i></a>
            </li>
            <li class="nav-item d-md-down-none">
                <a class="nav-link" href="#" style="color:white;"><i class="icon-location-pin"></i></a>
            </li>
            <li class="nav-item dropdown" style="color:white;">
                <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="../../assets/img/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                    <span class="d-md-down-none" style="color:white;">مدیر سیستم</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-header text-center">
                        <strong style="color:white;">حساب کاربری</strong>
                    </div>
        ...
        <button class="navbar-toggler aside-menu-toggler" type="button" style="color:white;">☰</button>

    </header>

    <div class="app-body">
        <div class="sidebar text-right float-left">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'index'}"><i class="icon-speedometer"></i> میزکار <span class="badge badge-primary">جدید</span></router-link>
                    </li>
                    ...
                    <li class="nav-item nav-dropdown">
                        <router-link class="nav-link nav-dropdown-toggle" to="" ><i class="icon-star"></i> محصولات</router-link>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'add_product'}" exact><i class="icon-star"></i> ثبت محصول </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'show_product'}" exact><i class="icon-star"></i> نمایش محصول</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <router-link class="nav-link nav-dropdown-toggle" to=""><i class="icon-puzzle"></i>اخبار</router-link>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'add_news'}" exact><i class="icon-puzzle"></i>ثبت خبر</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'show_news'}" exact><i class="icon-puzzle"></i> نمایش خبر</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item nav-dropdown">
                        <router-link class="nav-link nav-dropdown-toggle" to=""><i class="icon-puzzle"></i>مقالات</router-link>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'add_article'}" exact><i class="icon-puzzle"></i>ثبت مقاله</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{name:'show_article'}" exact><i class="icon-puzzle"></i> نمایش مقاله</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'comment'}" exact><i class="icon-pie-chart"></i>نظرات </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'answer'}" exact><i class="icon-pie-chart"></i>پاسخ ها</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'showAnswer'}" exact><i class="icon-pie-chart"></i>نمایش پاسخ ها</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'users'}" exact><i class="icon-pie-chart"></i>کاربران</router-link>
                    </li>
                    <li class="nav-item">
                        <router-link class="nav-link" :to="{name:'slider'}" exact><i class="icon-pie-chart"></i>اسلایدر</router-link>
                    </li>
                    <li class="divider"></li>
                    <li class="nav-title" style="font-family: IRANSansWeb">
                        بخش ها
                    </li>
                    <li class="nav-item nav-dropdown">
                        <router-link class="nav-link nav-dropdown-toggle" to="#"><i class="icon-star"></i> صفحات</router-link>
                        <ul class="nav-dropdown-items">
                        </ul>
                    </li>
        ...
        <main class="main">
            ...
            <!-- Breadcrumb -->
            <ol class="breadcrumb  mt-3 fixed-top" style="
    ...
    <footer class="app-footer w-100" style="background-color: #000035">
        <a href="" style="font-family: IRANSansWeb;color: white">Arka Invent </a>
    </footer>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        //     //     next();
        //     // }else{
        //     //     alert('شما اجازه ی دسترسی به این بخش را ندارید')
        //     //     next();
        //     // }
...
<style scoped>
    ...
    *::after {
    ...
    pre,
    samp {
        font-family:IRANSansWeb, Monaco, Consolas, "Liberation Mono", "Courier New", monospace; }
    ...
    .app-header.navbar .navbar-brand {
        ...
        background-image: url("../../assets/img/Arka_logo.png");
    ...
    *[dir="rtl"] .aside-menu-off-canvas .aside-menu .tab-content {
        height: calc(100vh - 2.375rem - 55px); }
    @media (min-width: 992px) {
        *[dir="rtl"] .sidebar-minimized .nav-link, *[dir="rtl"] .sidebar-minimized .navbar .dropdown-toggle, .navbar *[dir="rtl"] .sidebar-minimized .dropdown-toggle {
            padding-right: 0 !important; }
        *[dir="rtl"] .sidebar-minimized .nav-link i, *[dir="rtl"] .sidebar-minimized .navbar .dropdown-toggle i, .navbar *[dir="rtl"] .sidebar-minimized .dropdown-toggle i {
            float: right !important; }
        ...
        *[dir="rtl"] .aside-menu-fixed.aside-menu-hidden .main, *[dir="rtl"] .aside-menu-fixed.aside-menu-hidden .app-footer {
            margin-left: 0; } }
    @media (max-width: 1199px) {
        *[dir="rtl"] .sidebar-mobile-show .sidebar {
            margin-left: -220px;
            margin-right: inherit; }
        *[dir="rtl"] .sidebar {
            margin-right: -220px; }
        *[dir="rtl"] .sidebar-mobile-show .main {
            margin-left: -220px !important;
            margin-right: 220px !important; }
        *[dir="rtl"] .aside-menu-fixed .aside-menu {
            right: auto;
    ...
    *[dir="rtl"] .icons-list li .desc {
        margin-right: 50px;
        margin-left: 0; }
    *[dir="rtl"] .icons-list li .desc .title {
        font-size: 0.8em; }
